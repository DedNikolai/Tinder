...
public class MessegeDAO {
    public void save (Messege messege) {
        ...
        String sql = "INSERT INTO dn_messeges(id, who_messege, whom_messege, time, text) VALUES(?,?,?,?,?)";
    ...
    public List<Messege> get(String whoMessege, String whomMessege) {
        ...
        String sql = "SELECT * FROM dn_messeges WHERE who_messege='" + whoMessege + "' AND whom_messege='" + whomMessege+"'";
