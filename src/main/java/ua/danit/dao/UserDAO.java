...
public class UserDAO {
    ...
    public void save (User user) {
        String sql = "INSERT INTO dn_user(login, name, photoURL, password, sex) VALUES(?,?,?,?)";
    ...
    public static Map<Integer, User> getListOfUsers(String sex) {
        ...
        String sql = "SELECT * FROM dn_user WHERE sex='" + sex + "'";
    ...
    public User get(String str) {
        ...
        String sql = "SELECT * FROM dn_user WHERE login='" + str + "'";
